...
import { filters, sortOptions, singleFilter } from "./Filters";
...
//   const currentSubcategory = queryParams.get('subcategory') || null; // Updated to handle single subcategory
...
//   const commonSubcategories = selectedCategory
//     ? [...new Set(productData
...
//   return (
//     <div>
//       <div className='flex flex-row justify-between xl:grid xl:grid-cols-[300px_minmax(900px,_1fr)] gap-[10rem] mx-10  '>
//         <section>
//           <h1 className=' text-6xl ' >Categories</h1>
//           <ul className=' bg-light-bg-color flex flex-col space-y-3 h-auto my-auto px-2 py-5 mt-5 border-border-color ' >
//             {categories.map((category) => (
//               <li className={`text-3xl ${selectedCategory === category ? 'font-bold' : ''}`} key={category}>
...
//                   >
//                     <img
//                       className={`w-7 h-7 bg-light-text-color transform ${
//                         selectedCategory === category ? 'rotate-90' : 'rotate-0'
//                       }`}
//                       src={arrowIcon}
//                       alt='Arrow Icon'
//                     />
...
//                       <li className={`text-xl ${selectedSubcategory === subcategory ? 'font-bold' : ''}`} key={subcategory}>
//                         <label>
//                           <input
//                             type='radio'
//                             name='subcategory'
...
//           <div className=' flex justify-between  max-w-[95rem] flex-wrap mt-10'>
