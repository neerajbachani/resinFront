...
//               <path d="M19 5H5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V7C21 5.89543 20.1046 5 19 5Z" stroke="currentColor" strokeLinejoin="round" />
//               <path d="M3 7L12 13L21 7" stroke="currentColor"  strokeLinejoin="round" />
//             </svg>
...
//       </div>
//       <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
//                     <AddressCard addresses={addresses} onAddressClick={handleAddressClick} />
//                 </div>
//     </div>
//   );
// };
          ...
          <div className="border p-5 bg-white shadow-lg rounded-md">
            ...
            <div className="space-y-3 font-semibold">
              ...
              <div className="flex justify-between font-bold text-lg">
                ...
                <span className="text-green-700">₹{order.order?.discountedPrice}</span>
              </div>
            </div>
