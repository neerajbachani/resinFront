...
export default function ProductDetails() {
  // const { product,review } = useSelector(store => store);
...
useEffect(() => {
  ...
  // const dropdownOptions = ['Details', 'Highlights', 'Ratings'];
  ...
  const toggleDropdown1 = () => {
    setIsOpen1(!isOpen1);
    if (isOpen2) setIsOpen2(false); // Close other dropdown if open
  };

  const toggleDropdown2 = () => {
    setIsOpen2(!isOpen2);
    if (isOpen1) setIsOpen1(false); // Close other dropdown if open
  };
  ...
  return (
    <div className="bg-white">
      ...
      <div className="grid-col-3">
        ...
        {/* Image gallery */}
        <div className=' flex flex-col md:flex-row mx-auto  lg:max-w-7xl   px-20 pt-10 mb-10 col-span-1 '>
          <div className=" py-auto ">
            <div className=" sm:overflow-hidden sm:rounded-lg">
              <img
                src={`${product.product?.image}`}
                alt='product_detail'
                className="h-[35rem] w-[28rem] object-cover "
              />
            </div>
          </div>
          ...
          <div className=" max-w-2xl px-4 pb-16 pt-10 sm:px-6 w-full col-span-1   lg:pl-20 lg:pb-24 lg:pt-16">
            ...
            <div className=' ' >
              ...
              <h1 className="text-xl font-bold tracking-tight text-secondary-dark-color font-poppins sm:text-5xl">{product.product?.name}</h1>
  ...
  <div className="flex flex-col">
    ...
    <p className=' text-center text-primarycolor font-poppins text-[0.9rem] ssm:text-[1rem] md:text-[1.2rem] lg:text-xl '> no matter your budget.</p>
  ...
  ssm:h-[3.68rem] md:w-[4.16rem] md:h-[4.16rem] lg:h-14 lg:w-14  " />
    ...
    <p className=' text-primarycolor font-poppins text-center  ssm:text-[1rem] font-kurale   text-[0.9rem] md:text-[1.2rem] lg:text-xl '> no matter your budget.</p>
          </div>
          <div className="flex flex-col items-center">
  ...
  ssm:h-[3.68rem] md:w-[4.16rem] md:h-[4.16rem] lg:h-14 lg:w-14  " />
    ...
    <p className=' text-primarycolor font-poppins text-center text-[0.9rem] ssm:text-[1rem] font-kurale  md:text-[1.2rem] lg:text-xl '> no matter your budget.</p>
          </div>
        </div>
