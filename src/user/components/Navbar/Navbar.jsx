...
//         <img src={logo} className='w-28 h-28 object-cover' />
//         {/* <h1 className=' text-7xl'>Resin.</h1> */}
//         <ul className='flex font-poppins gap-5'>
//           <li className={`text-xl ${isActive('/') ? 'text-primarycolor' : 'text-secondary-dark-color'} hover:underline`}>
//             <Link to='/'>Home</Link>
//           </li>
//           <li className={`text-xl ${isActive('/products') ? 'text-primarycolor' : 'text-secondary-dark-color'} hover:underline`}>
//             {/* <Link to='/products'>All Products</Link> */}
//             <a href='/products'>All Products</a>
//           </li>
//           <li className={`text-xl ${isActive('/feature') ? 'text-primarycolor' : 'text-secondary-dark-color'} hover:underline`}>
//             <Link to='/feature'>Coupon Code</Link>
//           </li>
//           <li className={`text-xl ${isActive('/about-us') ? 'text-primarycolor' : 'text-secondary-dark-color'} hover:underline`}>
//             <Link to='/about-us'>About Us</Link>
//           </li>
//           <li className={`text-xl ${isActive('/contact-us') ? 'text-primarycolor' : 'text-secondary-dark-color'} hover:underline`}>
