...
export const findProducts = (reqData) => async (dispatch) => {
  ...
  try {
    ...
    const  {data } = await 
    api.get(`/api/products?resin=${resin}&digitalArt=${digitalArt}&jewel=${jewel}&minPrice=${minPrice}&maxPrice=${maxPrice}&discount=${minDiscount}&stock=${stock}&sort=${sort}&pageNumber=${pageNumber}&pageSize=${pageSize}`);
