...
const ProductsTable = () => {
  ...
  const resin = searchParams.get("resin");
  ...
  useEffect(() => {
    setFilterValue({ availability, resin, sort });
    const data = {
      resin:resin || "",
  ...
  }, [availability, resin, sort,page,product.deleteProduct]);
        ...
        <Grid container spacing={2}>
          <Grid item xs={4}>
            <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">resin</InputLabel>
              <Select
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                value={filterValue.resin}
                label="resin"
                onChange={(e) => handleFilterChange(e, "resin")}
              >
                <MenuItem value={"wallclock"}>Resin</MenuItem>
                <MenuItem value={"digitalArt"}>Digital Art</MenuItem>
                <MenuItem value={"jewel"}>jewel</MenuItem>
